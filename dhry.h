...
//user configuration
#define DHRY_LOOPS   	10000		//number of loops to run
#define MATRIX_SIZE		20			//matrix dimension. was 50
...
typedef int     Arr_1_Dim [MATRIX_SIZE];        /* <-- changed from 50 */
typedef int     Arr_2_Dim [MATRIX_SIZE] [MATRIX_SIZE];   /* <-- changed from 50 */
